...
2\. \*\*Descuentos >20%\*\* generan pérdida promedio por transacción

3\. \*\*Forecast 2018:\*\* $819K proyectados, crecimiento del 11.7%
...
Python | pandas | matplotlib | SQL | SQLite | Power BI | Prophet | openpyxl | python-pptx
